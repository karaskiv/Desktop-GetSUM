...
e = Entry(root,width=28, borderwidth=5, font=(60))
...
button_clear = Button(root, text="AC", padx=35, pady=25, command=button_clear)
button_get = Button(root, text="Get", padx=134, pady=25, command=button_equal)
...
button_get.grid(row=5, columnspan=3)
